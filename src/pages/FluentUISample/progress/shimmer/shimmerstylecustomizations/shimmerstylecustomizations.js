...
const ShimmerStylingExample = () => {
  return (
    <>
      <div className="fluenttitle divpadt10">Shimmer styles customizations</div>
      <div>
        Style overrides of shimmering wave and space around in cases where
        Shimmer is placed on backgrounds different than the main background of
        the app. There are several scenarios that can be considered bellow:
      </div>
      <div>
        <b>1.</b> The recommended way by using the <b>shimmerColors</b> prop
        which in turn has 2 sub-scenarios:
      </div>
      <div className={classNames.indent}>
        <b>a. </b>When using
        <b>shimmerElements</b> prop to build the placeholder you can pass all 3
        possible colors to
      ...
      <div className={classNames.indent}>
        <b>b. </b>When using <b>customElementsGroup</b> prop to build the
        placeholder:
      </div>
      ...
      <div>
        <b>2. </b>Another way of doing it by using <b>Customizer</b> component
        wrapper.
      </div>
...
export default ShimmerStylingExample;
