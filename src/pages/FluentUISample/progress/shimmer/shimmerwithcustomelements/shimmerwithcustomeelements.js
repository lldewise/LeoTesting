...
const getCustomElementsExampleOne = () => {
  return (
...
const getCustomElementsExampleTwo = () => {
  return (
    <div style={wrapperStyle}>
      <ShimmerElementsGroup
        shimmerElements={[
...
const ShimmerCustomElementsExample = () => (
  <>
    ...
    <Fabric className={wrapperClass}>
      Using ShimmerElementsGroup component to build complex structures of the
      placeholder you need.
      <Shimmer
        customElementsGroup={getCustomElementsExampleOne()}
        width="350"
      />
      <Shimmer
        customElementsGroup={getCustomElementsExampleTwo()}
        width="550"
      />
      <Shimmer
...
export default ShimmerCustomElementsExample;
