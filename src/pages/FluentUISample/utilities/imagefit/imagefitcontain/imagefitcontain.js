...
export const ImageContainExample = () => {
  ...
  return (
    <div>
      ImageContainExample
      <p>
        Setting the imageFit property to "contain" will scale the image up or
        down to fit the frame, while maintaining its natural aspect ratio and
        without cropping the image.
      </p>
      <Label>
        The image has a wider aspect ratio (more landscape) than the frame, so
        the image is scaled to fit the width and centered in the available
        vertical space.
      </Label>
      <Image
        {...imageProps}
      ...
      <Label>
        ...
        the image is scaled to fit the height and centered in the available
        horizontal space.
      </Label>
      <Image
        {...imageProps}
...
export default ImageContainExample;
