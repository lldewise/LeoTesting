...
export const ImageMaximizeFrameExample = () => {
  ...
  return (
    <div>
      ...
      <p>
        Where the exact width and height of the image's frame is not known, such
        as when sizing an image as a percentage of its parent, you can use the
        "maximizeFrame" prop to expand the frame to fill the parent element.
      </p>
...
export default ImageMaximizeFrameExample;
