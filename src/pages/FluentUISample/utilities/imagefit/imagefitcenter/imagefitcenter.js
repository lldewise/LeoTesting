...
export const ImageCenterExample = () => {
  const imageProps = {
    ...
    width: 350,
    height: 150,
    onLoad: ev => logger.log('image loaded', ev),
  };
  return (
    <div>
      ImageCenterExample
      ...
      <Label>
        The image is larger than the frame, so all sides are cropped to center
        the image.
      </Label>
      <Image
        {...imageProps}
      ...
      <Label>
        ...
        frame. The image is centered in the available space.
      </Label>
      <Image
        {...imageProps}
...
export default ImageCenterExample;
