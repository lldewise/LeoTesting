...
export const ImageCenterCoverExample = () => {
  ...
  return (
    <div>
      ...
      <p>
        Setting the imageFit property to "centerCover" will cause the image to
        scale up or down proportionally. Images smaller than their frame will be
        rendered as "ImageFit.center", while images larger than both the frame's
        height and width will render as "ImageFit.cover".
      </p>
      <Label>
      ...
      <br />
      <Label>
        The image has a wider aspect ratio (more landscape) than the frame but
        is not as tall as the frame, so it's rendered at its natural size while
        cropping the sides.
      </Label>
      <Image
        {...imageProps}
      ...
      <br />
      <Label>
        The image has a taller aspect ratio (more portrait) than the frame but
        is not as wide as the frame, so it's rendered at its natural size while
      ...
      <br />
      <Label>
        These images are taller and wider than the frame, so they grow just
        enough to "cover" the frame area.
      </Label>
      <Image
        {...imageProps}
...
export default ImageCenterCoverExample;
