...
const dialogContentProps = {
  ...
  title:
    'This dialog also makes use of FocusTrapZone. Focus should be trapped in the dialog.',
...
const FocusTrapZoneDialogInPanelExample = () => {
...
export default FocusTrapZoneDialogInPanelExample;
