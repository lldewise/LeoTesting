...
const COLUMNS = [
  ...
  },
  {
    ...
    minWidth: 130,
    onRender: item => (
      <TextField readOnly defaultValue={'ReadOnly ' + item.name} />
    ),
  },
  {
    key: 'textfield2',
...
const detailsRowStyles = { root: { display: 'block', width: '100%' } };

export const FocusZoneListExample = () => {
...
export default FocusZoneListExample;
