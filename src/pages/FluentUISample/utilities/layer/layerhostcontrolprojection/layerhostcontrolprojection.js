...
export const LayerHostedExample = () => {
  ...
  const content = (
    <div className={styles.content}>This is example layer content.</div>
  );
  ...
  return (
    <div className={styles.root}>
      ...
      <p>
        ...
        important that you don't include children within the LayerHost. It's
        meant to contain Layered content only.)
      </p>
      <Toggle
      ...
      {showLayer ? (
        <Layer
          hostId={layerHostId}
          onLayerDidMount={logDidMount}
          onLayerWillUnmount={logWillUnmount}>
          {content}
        </Layer>
      ) : (
        content
      ...
      <p>
        If you do not specify a hostId, the hosted layer will default to being
        fixed to the page by default.
      </p>
      <Toggle
        styles={styles.toggle}
...
const logDidMount = () => logger.log('layer did mount');
const logWillUnmount = () => logger.log('layer will unmount');
...
export default LayerHostedExample;
