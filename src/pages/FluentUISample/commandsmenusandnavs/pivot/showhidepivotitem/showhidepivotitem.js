      ...
      <Pivot
        ...
        {showFirstItem && (
          <PivotItem headerText="Foo" itemKey="Foo" key="Foo">
            ...
            <Label>
              The selected item will not change when the number of pivot items
              changes.
            </Label>
            <Label>
              If the selected item was removed, the new first item will be
              selected.
            </Label>
          </PivotItem>
        )}
...
export default PivotRemoveExample;
