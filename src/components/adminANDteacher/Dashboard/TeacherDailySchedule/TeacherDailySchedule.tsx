...
import './TeacherDailySchedule.scss';
...
type TeacherDailyScheduleProps = {
  events: Events;
};

type TeacherDailyScheduleState = {
...
class TeacherDailySchedule extends Component<TeacherDailyScheduleProps> {
  state: TeacherDailyScheduleState = {
    timeSched: null,
    title: null,
    location: null,
  ...
  render() {
    ...
    return (
      <div className="teacherDailyCalendar">
