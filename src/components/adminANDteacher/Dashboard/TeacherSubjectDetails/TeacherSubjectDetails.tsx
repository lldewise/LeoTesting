...
import styles from './TeacherSubjectDetails.module.scss';
...
import classes from './TeacherSubjectDetails.module.scss';
...
const TeacherSubjectDetails: React.FC<SubjectDetailProps> = items => {
  const {
    id,
    title,
    timeSched,
  ...
  const onRenderCell = (item: any) => {
    return (
      <Link className={classes.teacherSubjectLink}>
