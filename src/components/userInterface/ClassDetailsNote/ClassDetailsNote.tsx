...
import classes from './ClassDetailsNote.module.scss';
import { intl } from '../../../util/commonFunction';
import { LabelNames } from '../../../util/constant';
import logger from 'loglevel';

type ClassDetailsNoteProps = {
  item: any;
};

const ClassDetailsNote: React.FC<ClassDetailsNoteProps> = props => {
  const [divHeight, setDivHeight] = useState<number>(0);
  const [divComment, setDivComment] = useState<ReactElement<any, any>>();
  const [seeMore, setseeMore] = useState<ReactElement<any, any>>();
...
export default ClassDetailsNote;
